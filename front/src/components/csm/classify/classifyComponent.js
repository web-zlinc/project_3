...
class ClassifyComponent extends React.Component {
    ...
    componentWillMount() {
        this.props.getData("allShow.php", {
    ...
    render() {
        ...
        return ( < div id = "classify_container" > < div className = "classify_top" > 商品分类 < /div> < div className = "classify_content" > < div className = "left" > < ul > {
        ...
        } < /ul> < /div > < div className = "right" > < AllShowComponent data = {
            this.props.dataset.data1
        }
        type = {
            this.state.type
        } > < /AllShowComponent> < /div > < /div> < Footer / > < /div>)
    }
}
